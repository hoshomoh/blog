...
Unfortunately, my team didn't win. We ended the day at a local pub that brews its own beer. trivago had paid for us all to drink as much as we can. We drank, shared our respective experiences in regard to the check-in week, shared contact details and went our separate ways. 
...
[trivago](https://company.trivago.com/) is a meta-search. The simplest way to think about trivago is "Google" but for hotels. As a user, you have chosen Austria to be your holiday destination, however, picking the perfect accommodation for your stay can be challenging because there is just so much variable to consider coupled with the fact that the same accommodation can have different prices across multiple OTA or booking platforms. {% sidenote 'ota-meaning' 'OTA is an acronym for *Online Travel Agency*. You can find a list of OTA [here](https://en.wikipedia.org/wiki/Category:Online_travel_agencies)' %} 
